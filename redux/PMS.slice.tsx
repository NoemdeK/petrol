...
export const chartAllRegionPMS = createAsyncThunk(
  'prices/chartAllRegionPMS',
  async () => {
    try {
      const response = await axios(
        'https://petrodata.zainnovations.com/api/v1/data/chartAllRegionPMS'
      );
...
export const prices = createSlice({
  ...
  extraReducers: (builder) => {
    builder
      .addCase(chartAllRegionPMS.pending, (state) => {
        state.loading = true;
        state.error = null;
      })
      .addCase(
        chartAllRegionPMS.fulfilled,
