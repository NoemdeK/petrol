...
const ClientComponent = ({ stats, page, overall, recent }: any) => {
  ...
  const backgroundColorz = isNegativeChangez
    ? "text-red-500"
    : "text-green-600";
  ...
  return (
    <div>
      <div className="flex flex-col justify-between md:items-end gap-2 md:flex-row">
        <div className="">
          <p className="text-accent-foreground text-xs mb-3">
            Home &gt; {page || "PMS"}
          </p>
          <p className="whitespace-nowrap text-accent-foreground">
            {page || "PMS"}
          </p>
        </div>
        <div className="flex  items-end gap-1 flex-col md:flex-row">
          ...
          <div className="w-full items-start flex flex-col justify-start  gap-2 ">
            <Region
              ...
              setSelectedNames={handleRegionSelectChange}
            />
          </div>
        </div>
      </div>
      ...
      <div className=" w-full h-20 p-2">
        <div className="flex items-center gap-2 md:gap-4">
          ...
          <div className="flex">
            <p
              className={cn(
                " font-normal px-3 h-fit rounded-md text-white  text-sm",
                backgroundColor
              )}
            >
            ...
            <p
              className={cn(
                " font-normal px-3 rounded-md  text-sm whitespace-nowrap",
                backgroundColorz
              )}
            >
              {recent}
