...
export const columns: ColumnDef<any>[] = [
  {
    ...
    cell: ({ row }) => {
      return <div className="">{row.getValue("product")}</div>;
    },
  },
  {
    accessorKey: "price",
  ...
  },
  {
    ...
    header: ({}) => {
      return <div className="">Price Date</div>;
    },
    cell: ({ row }) => {
      return <div>{row.getValue("priceDate")}</div>;
    },
  },
  {
    accessorKey: "uploadedBy",
    header: ({}) => {
      return <div className="">Uploaded By</div>;
    },
    cell: ({ row }) => {
...

  {
    ...
    header: ({}) => {
      return <div className="">Upload Date</div>;
    },
    cell: ({ row }) => {
      return <div>{row.getValue("uploadDate")}</div>;
    },
  },
];
  ...
  return (
    <div className="px-2 h-full mt-12">
      <div className="flex justify-between lg:flex-row flex-col lg:items-center py-4">
        <h4 className="text-lg md:text-xl font-medium my-4">ICE Data</h4>
        <Filter />
      </div>
