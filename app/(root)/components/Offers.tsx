...
const Offers = () => {
  const OffersData = [
    {
      ...
      description: [
        "Detailing our data collection strategy, we emphasize sources, methods, and proprietary techniques.",
  ...
  return (
    <div className="py-12 px-4">
      <h4 className="text-base font-semibold text-left my-4">Our Process</h4>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3  gap-4 md:gap-8 mt-8">
        {OffersData.map((offer, i) => (
          <div
            key={i}
            className="max bg-white shadow-lg rounded-xl md:mt-0 mt-4"
          >
