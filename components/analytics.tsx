...
export const Analytics = () => {
  ...
  return (
    <main className='flex min-h-screen flex-col items-end justify-between  bg-white'>
      <div className='border-l-2 border-slate-200 flex flex-col  min-h-screen w-screen max-w-[1150px] p-4 md:p-8'>
        <div className='p-2 max-w-lg'></div>
        <div className='w-full bg-gray-100 rounded-md px-4 md:px-8 flex  gap-4 md:gap-10 p-2 mb-14 flex-wrap sm:flex-nowrap justify-around'>
          {cards}
        </div>
