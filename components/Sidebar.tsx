...
import { BarChart4, Code, Database,  History,  Rows,  Settings, Table, Upload, UserCog, Users, VideoIcon } from "lucide-react";
      ...
      <div className="px-3 py-2 flex-1">
        ...
        
        {
          ...
          <>
                ...
                className={cn(
                    "text-sm group flex p-3 w-full justify-start font-medium cursor-pointer  hover:bg-white/50 rounded-lg transition",
                    pathname === "/dashboard/settings" ? "text-black font-bold bg-white/50 " : "text-accent-foreground",
                )}
                onClick={onClose}
