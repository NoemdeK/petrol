...
export const ScrollPartners = () => {
  return (
    // <div className="w-[100%] flex left-0 justify-center">
    //   <div className="overflow-x-scroll flex items-center shrink-0 gap-[1rem]">
    //     <div className="px-[1rem_!important] overflow-x-hidden">
    //       <div className="w-[300%] flex items-center gap-[6.5rem] justify-between pl-[1rem] animate-marquee hover:paused">
    //         <div className="flex items-center gap-[5rem] w-[100%]">
    //           <Image src={enterscale} alt="" className="object-contain" />
    //           <Image src={kira} alt="" className="object-contain" />

    //           <Image src={keramide} alt="" className="object-contain" />
    //           <Image src={hawiti} alt="" className="object-contain" />
    //           <Image src={applied} alt="" className="object-contain" />
    //           <Image src={flutterwave} alt="" className="object-contain" />
    //         </div>
    //         <div className="flex items-center gap-[5rem] w-[100%]">
    //           <Image src={enterscale} alt="" className="object-contain" />
    //           <Image src={kira} alt="" className="object-contain" />
